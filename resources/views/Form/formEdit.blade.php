...
<div class=" w-75 mt-4 mb-4  card p-2">
  <div class="row" >
    <div class="col-10">
...
<form class="w-50 h-25 mt-4" method="POST" action="{{route("update-item", $post->id)}}" enctype="multipart/form-data">
  @csrf
  {{-- @method('PUT') --}}
  ...
  <div class="mt-3">
    <img class="w-50 h-50" src="{{asset("image/".$post->featured_image)}}" alt="">
